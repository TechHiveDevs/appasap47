...
import ListTradeScreen from "../Entities/Trade/List.trade.screen";
import ShowTradeScreen from "../Entities/Trade/Show.trade.screen";
  ...
  return (
    <Stack.Navigator {...stackrops}>
      ...
      />
        ...
        <Stack.Screen
            name="ListTradeScreen"
            component={ListTradeScreen}
            options={screenOptions}
          />
          <Stack.Screen
          name="ShowTradeScreen"
          component={ShowTradeScreen}
          options={screenOptions}
        />
